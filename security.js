...
*	Edit for more security
* locate in windows: C:\Users\[USER]\AppData\Roaming\Mozilla\Firefox\Profiles\[RANDOM].default 
*/
// Поддержка WebP
...
// При водим поиск браузера в «стандартное» состояние — без поправок на наше местоположение
...
// Разбираемся с пуш уведомлениями. Чтобы не работали, когда закрыл страницу
...
// Отключаем слив данных на серверы Google
